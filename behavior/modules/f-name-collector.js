function fNameCollector() {
  ...
  function fNameGetSet() {
    const fName = document.getElementById("f-name-input");
    ...
    if (fName.value.indexOf(" ") >= 0) {
      ...
      alert(
        `You have to provide only your first name, it also can't contain spaces.`
      );
    }
  ...
  document
    ...
    .addEventListener("click", fNameGetSet);
}
