...
let themeSwitch = document.getElementById('dn')
...
function themeHandlerStep1() {
    ...
    function themeSelectionHandler() {
        ...
        if (chosenTheme === 'dark') {
            ...
            document.getElementById('step1-body').style.backgroundImage= `url(${lightGif})`
            ...
            document.getElementById('step1-body').style.backgroundImage= `url(${darkGif})`
